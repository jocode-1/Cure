...
require 'vendor/autoload.php';
 ...
 class MailService{
    ...
    public function acceptMail($email,$merchant_name,$application_id,$name,$amount,$period){
		...
		//	$mail->SMTPDebug = 3;                      
			...
			$mail->Password   = 'Javax.swing_202';                                 // SMTP password
			$mail->SMTPSecure  = 'ssl';
			$mail->Port       = 465; 
    ...
    public function newMail($email,$merchant_name,$application_id,$name,$amount,$period){

       
        $body = file_get_contents('templates/newMail.phtml');
        $body = str_replace('%merchant%', $merchant_name, $body); 
        $body = str_replace('%name%', $name, $body); 
        $body = str_replace('%amount%', $amount, $body); 
        $body = str_replace('%app%', $application_id, $body); 
